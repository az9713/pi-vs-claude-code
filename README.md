...
| Document | Audience | Description |
| --- | --- | --- |
| **[COMPARISON.md](COMPARISON.md)** | All | Feature-by-feature comparison of Claude Code vs Pi Agent across 12 categories |
| **[RESERVED_KEYS.md](RESERVED_KEYS.md)** | Extension authors | Pi reserved keybindings, overridable keys, and safe keys |
| **[THEME.md](THEME.md)** | Extension authors | Color token conventions (`success`, `accent`, `warning`, `dim`, `muted`) |
| **[TOOLS.md](TOOLS.md)** | Extension authors | Built-in tool function signatures (`read`, `bash`, `edit`, `write`) |
